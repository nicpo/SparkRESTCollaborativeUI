app.controller('CorrelationCtrl', ['$scope', 'Statistics', '$modalInstance', 'selectedItem', 'Utils', function ($scope, Statistics, $modalInstance, selectedItem, Utils) {
    ...
    $scope.name = 'Correlation on ' + selectedItem.name;

    var applyDefaults = function () {
        $scope.method = 'pearson';
    ...
    $scope.onConfirmClick = function () {
        ...
        Statistics.correlation($scope).then(function () {
